...
3. **O núcleo de quem você é** — Mestre do Dia + força + Arquétipos dominantes integrados: funcionamento psicológico, estilo emocional, tomada de decisão. Tendências, distorções sob estresse, potenciais. **Aqui o Premium se diferencia**: apresente o sistema dos 10 Arquétipos de forma didática e breve (descrevem como cada energia do mapa se relaciona com o seu centro — nomeie os 10 em uma passagem elegante) e então aprofunde APENAS os que aparecem no mapa da pessoa, sempre nome técnico + tradução em comportamento (ver "Espírito Poético Explicativo do Saju" em GUIA_DE_VOZ.md).
