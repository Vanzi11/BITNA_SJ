...
- **Os dez deuses (十神) são o jargão mais abstrato do Saju — nunca defina um só com um rótulo poético.** Ancore em uma cena ou comportamento concreto, não só num adjetivo bonito. Ex. correto: "Deus do Alimento (食神 — o arquétipo de quem produz por prazer, não por meta: termina um projeto e já está esboçando o próximo, porque criar é o combustível, não um meio pra chegar em outro lugar)". Ex. incorreto (vago demais): "Deus do Alimento — o arquétipo ligado à criação serena". Se o termo reaparecer páginas depois, não presuma que o leitor lembra — um lembrete curto entre parênteses já resolve, ex.: "decide a partir do Deus do Alimento (o mesmo arquétipo de quem cria por prazer, já visto antes)".
