...
11. **Nota final** — *"Este relatório é uma ferramenta de autoconhecimento a dois baseada na tradição coreana do gunghap. Nenhum mapa determina uma relação, uma decisão de negócio ou o futuro de vocês: ela é construída pelas escolhas, pelo diálogo e pelo cuidado de ambos. Ele não substitui acompanhamento médico, psicológico, jurídico ou financeiro — as decisões são sempre de vocês."* (aprovado — item 3 do checklist de red team, revisado por advogado em 05/08/2026)
...
- **Os 10 Arquétipos (十神 — nunca "dez deuses" em texto de cliente, ver GUIA_DE_VOZ.md) são o jargão mais abstrato do Saju — nunca defina um só com um rótulo poético.** Ancore em uma cena ou comportamento concreto, não só num adjetivo bonito. Ex. correto: "Deus do Alimento (食神 — o arquétipo de quem produz por prazer, não por meta: termina um projeto e já está esboçando o próximo, porque criar é o combustível, não um meio pra chegar em outro lugar)". Ex. incorreto (vago demais): "Deus do Alimento — o arquétipo ligado à criação serena". Se o termo reaparecer páginas depois, não presuma que o leitor lembra — um lembrete curto entre parênteses já resolve, ex.: "decide a partir do Deus do Alimento (o mesmo arquétipo de quem cria por prazer, já visto antes)".
