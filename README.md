...
Empresa digital de relatórios de autoconhecimento baseados no Saju (사주, Quatro Pilares do Destino) e sinastria (궁합, gunghap), adaptados para o público brasileiro. Operada pela **Squad Bitna (Naia)** sob a governança de `GOVERNANCA_DA_SQUAD_BITNA.md` (ver também `NAIA.md`). Portfólio, preços reais em produção (Hotmart, conferidos em `empresa/LINKS_HOTMART.md`): Leitura Essencial R$ 47,60 · Leitura Completa R$ 149,30 · Sinastria Amorosa R$ 98,00 · Sinastria Profissional R$ 98,00 · Jornadas Bitna R$ 249 · Guia Ilustrado do Saju R$ 9,80 (decidido, em construção). Ver `empresa/EMPRESA.md` e a auditoria de coerência em `empresa/AUDITORIA_COERENCIA_PRODUTOS.md`.
